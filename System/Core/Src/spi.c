...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
	...
	if(spiHandle->Instance==SPI1)
	{
		...
		/**SPI1 GPIO Configuration
		   ...
		   PB5     ------> SPI1_MOSI
		*/
		GPIO_InitStruct.Pin = CK_Pin|MI_Pin;
		...
		GPIO_InitStruct.Pin = CS_Pin|MO_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
		GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
    ...
    if(spiHandle->Instance==SPI2) {
	    ...
	    HAL_NVIC_SetPriority(SPI2_RX_DMA_IRQn, 5, 0);
	    HAL_NVIC_EnableIRQ(SPI2_RX_DMA_IRQn);
	    HAL_NVIC_SetPriority(SPI2_TX_DMA_IRQn, 5, 0);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
	...
	if(spiHandle->Instance==SPI1)
	{
		...
		/**SPI1 GPIO Configuration
		   ...
		   PB5     ------> SPI1_MOSI
		*/
		HAL_GPIO_DeInit(GPIOA, CK_Pin|MI_Pin);

		HAL_GPIO_DeInit(GPIOB, CS_Pin|MO_Pin);
